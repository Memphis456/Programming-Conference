...
#creating main game sch as the score, the bird, the pipes and the physics
...
#making sure the player dies if they come in contact with the pipes or go out of the area  
...
#this is where the game starts and loads in all the assets needed
